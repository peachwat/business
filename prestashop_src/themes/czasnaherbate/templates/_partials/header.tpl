                  ...
                  <div class="blockcart cart-preview active" data-refresh-url="//czasnaherbate.net/module/ps_shoppingcart/ajax">
                     <div class="header">
                        <a style="display: flex; justify-content: center; align-items: center;" rel="nofollow" href="https://localhost/content/23-koszyk" title="Przejdź do koszyka">
                           <svg tyle="vertical-align: middle;" width="22" height="22" id="cart-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 17.947" fill="currentColor">
                              <path d="M3.382 6.447H0v2h1.189l2 9.5h13.622l2-9.5H20v-2h-3.382L13.394 0l-1.788.894 2.776 5.553H5.618L8.394.894 6.606 0Zm13.386 2H3.232l1.579 7.5h10.378Z" fill-rule="evenodd"></path>
                           </svg>

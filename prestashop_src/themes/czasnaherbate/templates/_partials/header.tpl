            ...
            <div class="">
                <div class="col-xs-12 topper">
                    ...
                    <div id="_desktop_user_info">
                        <div class="user-info">
                            <a href="https://localhost/login?back=my-account" title="Zaloguj się na swoje konto" rel="nofollow">
                                <span class="hidden-sm-down">Zaloguj się</span>
                                <svg id="account" xmlns="http://www.w3.org/2000/svg" style="vertical-align: middle;" width="24" height="24" viewBox="0 0 95 95" fill="currentColor"><path d="M47.5 95A47.513 47.513 0 0 1 29.011 3.732a47.513 47.513 0 0 1 36.978 87.535A47.183 47.183 0 0 1 47.5 95Zm1-40.55c-10.013 0-17.953 2.647-22.961 7.654-3.911 3.911-5.3 8.47-5.3 11.185a4.507 4.507 0 0 0 1.23 3.318 2.715 2.715 0 0 0 .336.353A38.493 38.493 0 0 0 48.5 87a40.679 40.679 0 0 0 26.565-9.993 4.347 4.347 0 0 0 1.694-3.718c0-2.716-1.388-7.275-5.3-11.185-5.006-5.004-12.946-7.653-22.959-7.653Zm0-32.97a14.13 14.13 0 1 0 14.13 14.13A14.146 14.146 0 0 0 48.5 21.481Z"></path></svg>
                            </a>
                        </div>
                    </div>
                    ...
                    <div id="search_widget" class="search-widget" data-search-controller-url="">
                        <form method="get" action="https://czasnaherbate.net/module/ambjolisearch/jolisearch">
                            ...
                            <svg width="20" height="20" id="search" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20.213 20" fill="currentColor"><path d="M12.317 13.77A5.874 5.874 0 1 0 6.443 7.9a5.874 5.874 0 0 0 5.874 5.87Zm0 2.021a7.9 7.9 0 1 0-7.9-7.9 7.9 7.9 0 0 0 7.9 7.9Z" fill-rule="evenodd"></path><path d="m0 18.571 4.422-4.422 1.429 1.429L1.429 20Z" fill-rule="evenodd"></path>
...
<nav class="header-nav">
 ...
 <div class="col-xs-12 menuold">
  ...
  <div class="blockcart cart-preview active" data-refresh-url="//czasnaherbate.net/module/ps_shoppingcart/ajax">
    <div class="header">
      <a style="display: flex; justify-content: center; align-items: center;" rel="nofollow" href="https://localhost/content/23-koszyk" title="Przejdź do koszyka">
        <svg tyle="vertical-align: middle;" width="22" height="22" id="cart-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 17.947" fill="currentColor"><path d="M3.382 6.447H0v2h1.189l2 9.5h13.622l2-9.5H20v-2h-3.382L13.394 0l-1.788.894 2.776 5.553H5.618L8.394.894 6.606 0Zm13.386 2H3.232l1.579 7.5h10.378Z" fill-rule="evenodd"></path></svg>
		...
		<div class="special">
			<a href="https://czasnaherbate.net/promocje">PROMOCJE</a>  {*TODO????*}
		</div>
	</div>
					</div>

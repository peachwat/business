...
<div class="special-footer"><div class="container">
  ...
  <div class="col-md-6">
      <div id="pushad-frame-footer"><div class="adpopmti_frame-content 00143efa2edce1826518d9cdc9e4d32fff6af60e" style="display: block;"><style>
    .\30 0143efa2edce1826518d9cdc9e4d32fff6af60e .adpop-email-newsletter-main-container {
        display: flex;
    ...
    .\30 0143efa2edce1826518d9cdc9e4d32fff6af60e .adpop-email-newsletter-title {
        font-size: 27px;
        font-family: 'PT Serif', serif;
        margin-bottom: 50px;
    }

    .\30 0143efa2edce1826518d9cdc9e4d32fff6af60e .adpop-email-newsletter-subtitle {
        line-height: 1.4;
    }

    .\30 0143efa2edce1826518d9cdc9e4d32fff6af60e .adpop-email-newsletter-form {
        display: flex;
        flex-direction: column;
    }

    .\30 0143efa2edce1826518d9cdc9e4d32fff6af60e .adpop-email-newsletter-in-row {
        display: flex;
    }

    .\30 0143efa2edce1826518d9cdc9e4d32fff6af60e .adpop-email-newsletter-input-with-button-wrapper {
        margin-bottom: 25px;
    }

    .\30 0143efa2edce1826518d9cdc9e4d32fff6af60e .adpop-email-newsletter-input {
        flex: 1 !important;
        width: auto !important;
        border: 1px solid #f9b93e !important;
    ...
    .\30 0143efa2edce1826518d9cdc9e4d32fff6af60e .adpop-email-newsletter-input:focus {
        border: 1px solid #f9b93e !important;
        padding: 8px 8px 9px !important;
        outline: 0 !important;
    }

    .\30 0143efa2edce1826518d9cdc9e4d32fff6af60e .adpop-email-newsletter-submit-button {
    ...
    .\30 0143efa2edce1826518d9cdc9e4d32fff6af60e .adpop-email-newsletter-submit-button::-webkit-input-placeholder { /* Chrome/Opera/Safari */
        color: #46220f !important;
    }
    .\30 0143efa2edce1826518d9cdc9e4d32fff6af60e .adpop-email-newsletter-submit-button::-moz-placeholder { /* Firefox 19+ */
        color: #46220f !important;
    }
    .\30 0143efa2edce1826518d9cdc9e4d32fff6af60e .adpop-email-newsletter-submit-button:-ms-input-placeholder { /* IE 10+ */
        color: #46220f !important;
    }
    .\30 0143efa2edce1826518d9cdc9e4d32fff6af60e .adpop-email-newsletter-submit-button:-moz-placeholder { /* Firefox 18- */
        color: #46220f !important;
    }

    .\30 0143efa2edce1826518d9cdc9e4d32fff6af60e .adpop-email-newsletter-submit-button:hover {
        background: #dea42d !important;
        border: 1px solid #dea42d !important;
    }

    .\30 0143efa2edce1826518d9cdc9e4d32fff6af60e .adpop-email-newsletter-info > p {
        font-size: 13px !important;
        color: #46220f !important;
    ...
    .\30 0143efa2edce1826518d9cdc9e4d32fff6af60e .adpop-email-newsletter-message {
        visibility: hidden;
        text-align: center;
        font-weight: 700;
        margin-top: 10px;
    ...
    .\30 0143efa2edce1826518d9cdc9e4d32fff6af60e .adpop-email-newsletter-message--has-error {
        color: red;
    }
...
<div class="adpop-email-newsletter-main-container">
    <div class="adpop-email-newsletter-titles-wrapper">
        <div class="adpop-email-newsletter-title">Zapisz się do newslettera</div>
        <div class="adpop-email-newsletter-subtitle">Otrzymuj informację o nowościach i wyprzedażach</div>
    </div>
    <form class="adpop-email-newsletter-form" data-events-attached="true">
        <div class="adpop-email-newsletter-in-row adpop-email-newsletter-input-with-button-wrapper">
            <input type="email" required="" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" class="adpop-email-newsletter-email adpop-email-newsletter-input" placeholder="Twój adres email">
            <button type="submit" class="adpop-email-newsletter-submit-button">SUBSKRYPCJA</button>
        </div>
        <div class="adpop-email-newsletter-info">
            <p>Możesz zrezygnować w każdej chwili. W tym celu należy odnaleźć szczegóły w naszej informacji prawnej</p>
        </div>
        <span class="adpop-email-newsletter-message">&nbsp;</span>
        <input type="hidden" class="adpop-email-newsletter-message--success" value="Dziękujemy za zapis do newslettera.">
        <input type="hidden" class="adpop-email-newsletter-message--error" value="Wystąpił błąd.">
    </form>
</div></div></div>
  ...
  <div class="container">
    <div class="row">
      ...
      <ul id="footer_sub_menu_12218" class="collapse">
                  <li>
            <a id="link-custom-page-logowanie-1" class="custom-page-link" href="https://localhost/login?back=my-account" title="">
              Logowanie
            </a>
          </li>
                  <li>
            <a id="link-custom-page-rejestracja-1" class="custom-page-link" href="https://localhost/login?create_account=1" title="">
              Rejestracja
            </a>
          </li>
              </ul>
      ...
      <ul id="footer_sub_menu_4620" class="collapse">
            ...
            <a id="link-cms-page-10-2" class="cms-page-link" href="https://localhost/content/5-secure-payment" title="">
              Metody płatności
                  ...
                  <li>
            <a id="link-static-page-contact-2" class="cms-page-link" href="https://localhost/contact-us" title="Skorzystaj z formularza kontaktowego">
              Kontakt z nami
            </a>
          </li>
                  <li>
      ...
      <p class="h3 hidden-sm-down">Informacje Prawne</p>
            <div class="title clearfix hidden-md-up" data-target="#footer_sub_menu_20066" data-toggle="collapse">
...
<div id="lgcookieslaw_banner" class="lgcookieslaw-banner lgcookieslaw-banner-floating lgcookieslaw-reject-button-enabled" style="display: none;">
    ...
    <div class="lgcookieslaw-modal-body">
        <div class="lgcookieslaw-modal-body-content">
                        ...
                        <div class="lgcookieslaw-section-name">
                            Funkcjonalne pliki cookie                                <div class="lgcookieslaw-badge lgcookieslaw-tooltip-container tooltipstered" role="tooltip">
                                    Techniczne
                                </div>
                                                    </div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="lgcookieslaw-section-purpose-content-cookies-table table">
                                                    <thead>
                                                        <tr>
                                                            <th>
                                                                <span class="lgcookieslaw-tooltip-container tooltipstered" role="tooltip">
                                                                    Cookie
                                                                </span>
                                                            </th>
                                                            <th>
    ...
    <div class="row">
      <div class="col-md-12">
                <div class="border-top">
                   <div class="copyl">
                      <p>© 2019 herbata.net All rights reserved.</p>
                   </div>
                  <div class="copyr">
                      <p><span>Projekt i realizacja: </span>
                        <a href="https://pd.agency/" target="_blank">pd.agency</a>
                      </p>
                  </div>
        <p></p>
   </div>

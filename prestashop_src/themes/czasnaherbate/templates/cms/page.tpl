        ...
        <style>
            ...
            .circle-icon {
                ...
                box-shadow: 
                    0 0 0 5px #fff, 
                    0 0 0 6px #f9a918,
                    0 0 15px 5px rgba(249, 169, 24, 0.4);
            ...
            <div class="about-content-width">
                ...
                <div class="stats-grid">
                    ...
                    <div class="stat-item">
                        <div class="circle-icon">
                            <img src="{$urls.theme_assets}img/ikona-herbata.png" alt="Herbaty">
                        </div>
                        <span class="stat-number">250</span>
                        <span class="stat-label">Herbat klasycznych<br>i kompozycji w ofercie</span>
                    </div>

                    <div class="stat-item">
                        <div class="circle-icon">
                            <img src="{$urls.theme_assets}img/iko3.png" alt="Filiżanki">
                        </div>
                        <span class="stat-number">220 mln</span>
                        <span class="stat-label">Wypitych filiżanek herbat<br>przez naszych Klientów</span>
                    </div>

                    <div class="stat-item">
                        <div class="circle-icon">
                            <img src="{$urls.theme_assets}img/iko2.png" alt="Salony">
                        </div>
                        <span class="stat-number">72</span>
                        <span class="stat-label">Salony<br>Czas na Herbatę</span>
                    </div>

                    <div class="stat-item">
                        <div class="circle-icon">
                            <img src="{$urls.theme_assets}img/iko1.png" alt="Klienci">
                        </div>
                        <span class="stat-number">725 tys.</span>
                        <span class="stat-label">Zadowolonych<br>Klientów rocznie</span>
                    </div>
                </div>
                ...
                <div class="timeline-container">
                    ...
                    <div class="timeline-logo-wrapper">
                        <img src="{$urls.theme_assets}img/CnH-pierwsze-logo.png" alt="Pierwsze logo">
                    </div>
                    ...
                    <div class="brand-founding">
                        <h3>Założenie marki</h3>
                        <p>wejście na rynek z ofertą 36 herbat</p>
                    </div>

...
Projekt realizowany w ramach zajęć z przedmiotu Biznes elektroniczny. Celem projektu jest praktyczne zastosowanie narzędzi Open Source (Docker, Git, Selenium) do wdrożenia, konfiguracji oraz dostosowania sklepu internetowego Prestashop 1.7.8.
...
2. Uruchomienie Kontenerów: Użyj pliku docker-compose.yml do uruchomienia wszystkich wymaganych usług.
docker-compose up -d
